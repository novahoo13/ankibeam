...
### 30 秒了解 Anki Word Assistant

Anki Word Assistant 是一款 Chrome 浏览器扩展，它能够：
...
1. 点击浏览器工具栏中的 **Anki Word Assistant** 图标
2. 在输入框中输入要查询的单词或短语
3. （可选）从下拉菜单选择解析模板
4. 点击 **「解析」** 按钮
...
1. 查看 [GitHub Issues](https://github.com/novahoo13/anki-word-assistant/issues)
2. 提交新的 Issue 描述你的问题
3. 附上错误截图和操作步骤

---

_感谢使用 Anki Word Assistant！祝学习愉快！_ 🎓
