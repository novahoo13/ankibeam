## [~foosoft](https://git.sr.ht/~foosoft/)/anki-connect

-   [summary](https://git.sr.ht/~foosoft/anki-connect)
-   [tree](https://git.sr.ht/~foosoft/anki-connect/tree)
-   [log](https://git.sr.ht/~foosoft/anki-connect/log)
-   [refs](https://git.sr.ht/~foosoft/anki-connect/refs)

Anki plugin to expose a remote API for creating flash cards

[7b338ac6](https://git.sr.ht/~foosoft/anki-connect/commit/7b338ac6050d20c2c9cfa176e66d9081e218d796 "7b338ac6050d20c2c9cfa176e66d9081e218d796") — kuuuube [2 months ago](https://git.sr.ht/~foosoft/anki-connect/log?from=7b338ac6050d20c2c9cfa176e66d9081e218d796#log-7b338ac6050d20c2c9cfa176e66d9081e218d796)

Move startEditing to top of addNote to mitigate cache clearing

[47da1c50](https://git.sr.ht/~foosoft/anki-connect/commit/47da1c5039f42ad004acc57f528d6f873caffdc9 "47da1c5039f42ad004acc57f528d6f873caffdc9") — Yuki [6 months ago](https://git.sr.ht/~foosoft/anki-connect/log?from=47da1c5039f42ad004acc57f528d6f873caffdc9#log-47da1c5039f42ad004acc57f528d6f873caffdc9)

Fix empty request

[ab4d964d](https://git.sr.ht/~foosoft/anki-connect/commit/ab4d964d96712788889eb35d79471966aaf17ef6 "ab4d964d96712788889eb35d79471966aaf17ef6") — [Ken Micklas](https://git.sr.ht/~kmicklas/) [6 months ago](https://git.sr.ht/~foosoft/anki-connect/log?from=ab4d964d96712788889eb35d79471966aaf17ef6#log-ab4d964d96712788889eb35d79471966aaf17ef6)
...
[browse](https://git.sr.ht/~foosoft/anki-connect/tree)  [log](https://git.sr.ht/~foosoft/anki-connect/log) 

25.6.12.0

[browse](https://git.sr.ht/~foosoft/anki-connect/tree/25.6.12.0)  [.tar.gz](https://git.sr.ht/~foosoft/anki-connect/archive/25.6.12.0.tar.gz) 

### clone

read-only

[https://git.sr.ht/~foosoft/anki-connect](https://git.sr.ht/~foosoft/anki-connect)

read/write

git@git.sr.ht:~foosoft/anki-connect

     Clone repo to your account

You can also use your local clone with [git send-email](https://git-send-email.io/).

## [#](https://git.sr.ht/~foosoft/anki-connect#anki-connect)Anki-Connect
